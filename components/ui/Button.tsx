...
export function Button(props: any) {
  const base =
    "inline-flex items-center justify-center rounded-full px-5 py-2.5 text-sm font-semibold transition shadow-sm hover:shadow focus:outline-none focus:ring-2 focus:ring-blue-400/40 focus:ring-offset-0 ";
  ...
  const variant =
    props.variant === "secondary"
      ...
      : "border border-blue-300/25 bg-gradient-to-r from-blue-600 to-indigo-600 text-white shadow-[0_16px_40px_rgba(37,99,235,0.34)] hover:brightness-110";
