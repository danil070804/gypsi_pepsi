...
const baseInput =
  "w-full rounded-xl border border-white/10 bg-white/5 px-3 py-2 text-sm text-slate-100 placeholder:text-slate-400 outline-none " +
  "focus:border-b border-white/10lue-400/40 focus:ring-2 focus:ring-blue-500/20";
